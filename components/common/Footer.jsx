    ...
    return (
        <>
            <footer className="bg-[rgba(0,89,116,0.1)]">
                <div className="container-pl p-4  lg:py-8 flex flex-col lg:flex-row justify-center lg:justify-between items-start">
                    <div className="w-[90%] lg:w-[23%] text-justify">
                        ...
                        <p className="mt-5 text-[#0008] text-[15px] leading-[22.5px]">
                            <span>
                                ...
                                و تغيير در نگرش و عملكرد بيماران است.<span className="text-[#00B6BD]"><Link href="/">مشاهده بیشتر</Link></span>
                            </span>
                        </p>
                    </div>
                    <div className="p-0 lg:p-12 py-4 mr-1 lg:mr-10">
                        ...
                        <ul className="text-[15px] text-[#0007] py-3 menu-fo">
                            ...
                            <li className="mb-2"><Link href="/">بهترین ها</Link></li>
                            <li className="mb-2"><Link href="/">تازه ترین ها</Link></li>
                            <li className="mb-2"><Link href="/">پیوند های مفید</Link></li>
                    ...
                    <div className="p-0 lg:p-12 py-4 mr-1 lg:mr-10">
                        ...
                        <ul className="text-[15px] text-[#0007] py-3 menu-fo">
                            ...
                            <li className="mb-2"><Link href="/">بخش های ما</Link></li>
                            <li className="mb-2"><Link href="/">برنامه ما</Link></li>
                            <li className="mb-2"><Link href="/">مجله سلامت</Link></li>
                            <li className="mb-2"><Link href="/">نوبت دهی آنلاین</Link></li>
                            <li className="mb-2"><Link href="/">خدمات</Link></li>
                            <li className="mb-2"><Link href="/">نکات آموزشی</Link></li>
                            <li className="mb-2"><Link href="/">بیمه های طرف قرارداد</Link></li>
                            <li className="mb-2"><Link href="/">نظرات کاربران</Link></li>
                            <li className="mb-2"><Link href="/">عضویت</Link></li>
                        </ul>
                    </div>
                    <div className="min-w-[302px] w-[302px] p-3 text-[15px]">
                        ...
                        <div className="flex justify-center items-center soialmedia mt-4">
                            <a className="mx-5">
                ...
                <div className="bg-[rgb(245,245,245)] p-4 text-center">
                    <p >کلیه‌ی حقوق این وبسایت متعلق به شرکت دانش بنیان فن‌آوری اطلاعات شمال است.</p>
                </div>
            </footer>
        </>
    );
