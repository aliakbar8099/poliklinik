    ...
    return (
        <div className='flex justify-start lg:justify-center items-center p-5 h-[88vh] flex-col lg:flex-row'>
            <div id="form" className="bg-[#fff] flex justify-center w-full items-start flex-wrap lg:w-1/2 m-auto mt-[70px] lg:mt-5 shadow-lg p-4 border rounded-[20px] mx-2">
                ...
                <TextInput skeleton={load} onGetValue={getValue} defaultValueText={value?.fullname} nameInput="fullname" calssStyle="w-full md:w-1/2" title="نام و نام خانوادگی" msg="" />
                <TextInput skeleton={load} readOnly={true} onGetValue={getValue} defaultValueText={value?.NationalCode} nameInput="NationalCode" calssStyle="w-full md:w-1/2" title="کد ملی" msg="" />
                <TextInput skeleton={load} onGetValue={getValue} defaultValueText={value?.phoneNumber} nameInput="phoneNumber" calssStyle="w-full md:w-1/2" title="شماره تلفن" msg="" />
                {
                    load ?
                        <TextInput skeleton={load} onGetValue={getValue} defaultValueText={value?.email} nameInput="email" calssStyle="w-full md:w-1/2" title="تاریخ تولد" msg="" />
                        :
                ...
                <TextInput skeleton={load} onGetValue={getValue} defaultValueText={value?.email} nameInput="email" calssStyle="w-full md:w-1/2" title="ایمیل" msg="" />
                <TextInput skeleton={load} onGetValue={getValue} defaultValueText={value?.city} nameInput="city" calssStyle="w-full md:w-1/2" title="شهر" msg="" />
                <TextInput skeleton={load} onGetValue={getValue} defaultValueText={value?.adderess} nameInput="adderess" calssStyle="w-full" title="آدرس" msg="" />
