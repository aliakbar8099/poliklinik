...
function Section1() {
    ...
    const slider = [
        <img key={1} className="w-full h-full object-cover" src="/img/bgsec1.jpg" />,
        <img key={2} className="w-full h-full object-cover" src="/img/bgsec1.jpg" />,
    ]
    ...
    return (
        <>
            <section id="pageSect1" className="h-[90vh] w-full overflow-hidden relative">
                ...
                <SliderMain slider={slider} />
                <div
                    className="box_sect1 z-[1032] rounded-[40px] bg-[#E9FAFF] w-[90%] md:w-[60%] lg:w-[466px] h-[auto] absolute top-[50%]
